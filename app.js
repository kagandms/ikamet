    ...
    if (btnPrint) {
        btnPrint.addEventListener('click', () => {
            ...
            const printHtml = `
                ...
                <div id="pdf-content" style="font-family: 'Times New Roman', Times, serif; padding: 5mm 10mm; color: black; background: white; border: 4px double black; box-sizing: border-box; min-height: 269mm; max-width: 210mm; margin: 0 auto; -webkit-print-color-adjust: exact; print-color-adjust: exact; page-break-inside: avoid;">
